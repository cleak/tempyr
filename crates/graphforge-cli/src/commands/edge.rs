...
pub fn run_add(ctx: &ProjectContext, source: &str, target: &str, edge_type: &str) -> anyhow::Result<()> {
...
pub fn run_remove(ctx: &ProjectContext, source: &str, target: &str, edge_type: &str) -> anyhow::Result<()> {
